...
//  Place place = new Place(name:'Knuckles Mountains Range', 'Hiking. Water fall hunting. Natural bath', 'Scenery & Photography', '123,123,123');
  Place place = Place(
        ...
        builder: (context, AsyncSnapshot snapshot) {
          switch (snapshot.connectionState) {
            ...
            case ConnectionState.done:
              return Column(
                children: userBloc.buildMyPlaces(snapshot.data.documents, user),
              );
            default:
              return Column(
                children: userBloc.buildMyPlaces(snapshot.data.documents, user),
